...
- **Modelo Supervisado:** Detalle de la regresión/clasificación para predecir el tiempo de maduración de los pozos.
- **Modelo No Supervisado:** Detalle del algoritmo de clustering utilizado para descubrir perfiles productivos.
